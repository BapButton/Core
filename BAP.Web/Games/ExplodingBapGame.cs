...
namespace BAP.Web.Games
{
	...
	public class ExplodingBapGame : IBapGame
	{
		...
		public ExplodingBapGame(ILogger<ExplodingBapGame> logger, IBapMessageSender messageSender, GameHandler gameHandler, ISubscriber<ButtonPressedMessage> buttonPressedPipe)
		{
			Logger = logger;
