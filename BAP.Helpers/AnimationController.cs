...
namespace BAP.Helpers
{
    ...
    public class AnimationController : IDisposable
    {
        ...
        IBapMessageSender MsgSender { get; set; }
        ...
        public AnimationController(ILogger<AnimationController> logger, IBapMessageSender msgSender, IPublisher<AnimationCompleteMessage> animationCompleteSender)
        {
            Logger = logger;
            MsgSender = msgSender;
        ...
        private void RunAllAnimations()
        {
            ...
            if (!ButtonFrames.IsEmpty)
            {
                ...
                foreach (var nodeAndFrameHolder in CurrentAnimations)
                {
                    ...
                    if (frameToSend != null)
                    {
                        MsgSender.SendImage(nodeAndFrameHolder.Key, new ButtonImage(frameToSend.Image));
