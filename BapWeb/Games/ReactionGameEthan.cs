...
namespace BapWeb
{
    public class ReactionGameEthanDescription : IGameDescription
    {
    ...
    public class ReactionGameEthan : ReactionGameBase
    {
        ...
        public ReactionGameEthan(ILogger<ReactionGameBase> logger, ISubscriber<ButtonPressedMessage> buttonPressed, MessageSender messageSender, IServiceProvider services, ISubscriber<InternalSimpleGameUpdates> internalUpdatePipe) : base(buttonPressed, messageSender)
        {
            Services = services;
