...
{
    public class ReactionSpeedupGameDescription : IGameDescription
    {
    ...
    public class ReactionSpeedup : ReactionGameBase
    {
        ...
        public ReactionSpeedup(IGameDataSaver<ReactionSpeedupGameDescription> dbSaver, ISubscriber<ButtonPressedMessage> buttonPressed, ILogger<ReactionGame> logger, MessageSender messageSender) : base(buttonPressed, messageSender)
        {
            _logger = logger;
        ...
        public async void TimeForNextButton(Object source, System.Timers.ElapsedEventArgs e)
        {
            if (IsGameRunning)
            {
                ...
                else
                {
                    ...
                    string nextNodeId = TinkerButtonGameMethods.GetRandomNodeId(buttons.Except(NodeIdsCurrentlyShowingSomething).ToList());
