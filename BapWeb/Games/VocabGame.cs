...
namespace BapWeb.Games
{
    ...
    public class VocabGameDescription : IGameDescription
    {
    ...
    public class VocabGame : MathGameBase, ITinkerGame, IDisposable
    {
        ...
        public VocabGame(KeyboardHandler keyboardHandler, GameHandler gameHandler, ILogger<AdditionGame> logger, ISubscriber<KeyboardKeyPressedMessage> keyPressed, MessageSender messageSender, IGameDataSaver<AdditionGameDescription> dbSaver) : base(keyboardHandler, gameHandler, messageSender, keyPressed)
        {
            _logger = logger;
            DbSaver = dbSaver;
            RefreshSavedVocab();
        ...
        public override async Task<bool> Start()
        {
            ...
            await base.StartGame(1200, false, KeyboardType.SpanishLowerCase);
            return true;
        }
    }
}
