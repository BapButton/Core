...
namespace BapWeb.Games
{
    ...
    public abstract class MarqueGameBase : ITinkerGame
    {
        ...
        int AnimationTickCountAtStartOfAnimation { get; set; }
        IDisposable subscriptions = default!;
        ISubscriber<AnimationCompleteMessage> AnimationCompletePipe { get; set; }
        public MarqueGameBase(ILogger logger, MessageSender messageSender, AnimationController animationController, ISubscriber<AnimationCompleteMessage> animationCompletePipe)
        {
            _logger = logger;
