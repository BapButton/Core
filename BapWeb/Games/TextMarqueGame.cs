...
namespace BapWeb.Games
{
    ...
    public class TextMarqueGame : MarqueGameBase
    {
        ...
        public TextMarqueGame(GameHandler gameHandler, ILogger<TextMarqueGame> logger, MessageSender messageSender, AnimationController animationController, ISubscriber<AnimationCompleteMessage> animationCompletePipe) : base(logger, messageSender, animationController, animationCompletePipe)
        {
