...
{
    public class LetterTestDescription : IGameDescription
    {
    ...
    public class LetterTest : ITinkerGame
    {
        ...
        public LetterTest(ILogger<LetterTest> logger, MessageSender messageSender, AnimationController animationController, ISubscriber<AnimationCompleteMessage> animationCompletePipe)
        {
            _logger = logger;
