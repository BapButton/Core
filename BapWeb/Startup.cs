...
namespace BapWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient(typeof(IGameDataSaver<>), typeof(DefaultGameDataSaver<>));
            ...
            services.Scan(scan => scan.FromApplicationDependencies()
                    .AddClasses(t => { t.AssignableTo<ITinkerController>(); })
                      .AsImplementedInterfaces()
                      .WithTransientLifetime());
            services.Scan(scan => scan.FromCallingAssembly()
                    .AddClasses(t => { t.AssignableTo<ITinkerGame>(); })
                      .AsSelf()
                      .WithTransientLifetime());
            services.Scan(scan => scan.FromCallingAssembly()
                    .AddClasses(t => { t.AssignableTo<IGameDescription>(); })
                      .AsImplementedInterfaces().WithSingletonLifetime());
            services.Scan(scan => scan.FromCallingAssembly()
                    .AddClasses(t => { t.AssignableTo<IGameDescription>(); })
                      .AsSelf().WithSingletonLifetime());
            services.Scan(scan => scan.FromApplicationDependencies()
                    .AddClasses(t => { t.AssignableTo<IKeyboardController>(); })
