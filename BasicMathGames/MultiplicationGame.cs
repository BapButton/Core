...
namespace BAP.BasicMathGames
{
	...
	public class MultiplicationGame : KeyboardGameBase
	{
		...
		public MultiplicationGame(KeyboardHandler keyboardHandler, GameHandler gameHandler, ILogger<AdditionGame> logger, ISubscriber<KeyboardKeyPressedMessage> keyPressed, IBapMessageSender messageSender, IGameDataSaver<AdditionGameDescription> dbSaver) : base(keyboardHandler, gameHandler, messageSender, keyPressed)
		{
			_logger = logger;
			DbSaver = dbSaver;
		}
